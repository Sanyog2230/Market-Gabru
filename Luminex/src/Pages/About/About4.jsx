...
const About4 = () => {
  ...
  return (
    <div className="relative h-[80vh] mt-15 w-full bg-cover bg-center bg-[url('https://cdn.prod.website-files.com/683970e766b2814fc9e591a4/683c04cccc75e24bfe6dc48a_banner%20bg-p-2000.webp')]">
      {/* Overlay */}
