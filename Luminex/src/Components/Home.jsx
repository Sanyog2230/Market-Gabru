...
import Layout from "./Besidemarque";
      ...
      <div className="relative h-[110vh] w-full bg-cover bg-center bg-[url('https://cdn.prod.website-files.com/683970e766b2814fc9e591a4/683c04cccc75e24bfe6dc48a_banner%20bg-p-2000.webp')]">
        ...
        >
          ...
          <p
            ...
            text-[clamp(0.7rem,2vw,1rem)] sm:text-[clamp(0.8rem,1.8vw,1.1rem)] lg:text-[clamp(0.9rem,1.5vw,1.2rem)]
            break-words"
          >
          ...
          {/* Buttons */}
          <div className="flex items-center gap-6 mt-6 md:mt-10 flex-wrap justify-center relative md:translate-x-[-2rem]">
